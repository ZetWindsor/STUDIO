...
app.post('/api/books', (req, res) => {
    ...
    const newBook: Book = { isbn, title, author, category, pages, firstYearPublication, language };
...
app.put("/api/books/:isbn", (req, res) => {
    ...
    books = books.map(p => p.isbn === Number(isbn) ? ({ ...p, title }) : p)
